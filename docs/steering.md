...
| `steering-code-economy` | Code economy defaults: prefer deletion, stdlib, and minimal hand-rolled solutions over new abstractions. Avoid speculative generality, near-duplicate code, and heavyweight dependencies. Always-on steering. Opt-in. |
