...
(JSON, RSS/Atom, git) that return small structured output. `references/recipes.md`
is the cookbook. Reserve web fetching for genuine prose (a migration guide, a
post explaining a breaking change).
