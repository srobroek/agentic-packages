...
MUST Run against local code only. A fuzz target that opens a network connection to anything beyond loopback is out of scope and gets rewritten or dropped.
