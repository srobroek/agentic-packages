---
name: playwright
description: Automate browser tasks through a Playwright MCP server -- navigate, click, fill forms, extract page data. Use when asked to browse, scrape, test a web UI, or interact with a live page.
---
