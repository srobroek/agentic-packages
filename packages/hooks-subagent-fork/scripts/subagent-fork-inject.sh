...
CTX+="- Put everything the subagent needs into the spawn prompt; forked turns are not a substitute for a complete brief. fork_turns=\"all\" and values above 3 are denied by policy.${NL}"
