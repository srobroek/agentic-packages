...
- Starting in an existing repo or worktree with prior activity
- Resuming after context loss, compaction, `/clear`, or a paused session
- User asks to catch up, continue, resume, read a handover, or report what is next
- The branch/spec/worktree suggests unfinished work and a saved handover may exist
