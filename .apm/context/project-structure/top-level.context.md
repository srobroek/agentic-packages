...
- `apps/` for user-facing surfaces: web, admin, mobile, desktop, marketing, and
  docs.
- `services/` for long-lived backend deployables: API, GraphQL, RPC, webhooks,
  auth, billing, and notifications.
...
- `tools/` for maintained CLIs, generators, MCP implementations, and reusable
  developer tooling.
