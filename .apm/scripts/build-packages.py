#!/usr/bin/env python3
"""Materialize curated APM package bundles from canonical first-party assets."""
...
def main() -> int:
    for package_name in RETIRED_GENERATED_PACKAGES:
    ...
    for bundle in BUNDLES:
        ...
        print(f"updated {PACKAGES / bundle.name}")
    return 0
